...
public sealed class ViceBridge: IViceBridge
{
	...
	private void OnViceResponse(ViceResponseEventArgs e) => ViceResponse?.Invoke(this, e);
	private void OnConnectedChanged(ConnectedChangedEventArgs e) => ConnectedChanged?.Invoke(this, e);
	private static async Task WaitForPort(int port, CancellationToken ct = default)
	{
		bool isAvailable;
		do
		{
